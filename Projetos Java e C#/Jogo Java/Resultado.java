...
// Classe gerada pelo framework (serve pra mostrar a resposta do resultado escolhido)
public class Resultado extends javax.swing.JDialog {
    private static String mensagem;
    
    public Resultado(java.awt.Frame parent, boolean modal, String mensagem) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(394, 153));
        setResizable(false);

        jPanel2.setBackground(new java.awt.Color(102, 102, 102));

        jButton1.setText("Ok");
        jButton1.setAlignmentX(136.0F);
        ...
        txtareaMensagem.setBackground(new java.awt.Color(204, 204, 204));
        txtareaMensagem.setColumns(20);
        txtareaMensagem.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        txtareaMensagem.setLineWrap(true);
        txtareaMensagem.setRows(3);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Resultado dialog = new Resultado(new javax.swing.JFrame(), true, mensagem);
